            ...
            <div class="col-md-12 mb-3">
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Cuenta registrada</div>
                      <div class="h6 mb-0 font-weight-bold text-gray-800">
                        <?php 
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    ...
                    <div class="col mr-0">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Contratos</div>
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                ...
                <div class="col-lg-3">
                    <div class="card shadow h-100">
                      <div class="card-body">
                        ...
                        <div class="panel-heading"> Lotes recientes
                        </div>
