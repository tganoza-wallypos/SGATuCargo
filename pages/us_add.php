  ...
  console.log($.getCities("Batangas")); 
          ...
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Agregar usuario</h4>
            </div>
            <a href="user.php?action=add" type="button" class="btn btn-primary bg-gradient-primary">Atras</a>
            <div class="card-body">
              <div class="table-responsive">
                        <form role="form" method="post" action="us_transac.php?action=add">
                            ...
                            <button type="reset" class="btn btn-danger btn-block"><i class="fa fa-times fa-fw"></i>Reinicar</button>
