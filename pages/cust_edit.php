...
?>
            ...
            </div><a  type="button" class="btn btn-primary bg-gradient-primary btn-block" href="customer.php?"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Atrás </a>
            <div class="card-body">
            ...
            <form role="form" method="post" action="cust_edit1.php">
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-sm-9">
                <input class="form-control" placeholder="Nro RUC" name="RUC" value="<?php echo $b; ?>" required pattern="[0-9]{11}">
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-3" style="padding-top: 5px;">
